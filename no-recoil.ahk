; Apex Legends No Recoil Script v2.3 17052019
; use ahkhider.
#NoEnv
...
if ump {							;RE-45 RECOIL
...
else if akm {						;PROWLER RECOIL (mgsweet - 21/06/2021)
	loop {
		sleep, 10
...
else if uzi {						;R301 RECOIL (by mgsweet - 21/06/2021)
	loop {
		sleep, 10
		DllCall("mouse_event", uint, 2, int, 0, int, 0, uint, 0, int, 0)
		sleep 1
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", 0, "UInt", 8*modifier)
		sleep 72
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -2*modifier, "UInt", 3*modifier)
		sleep 72
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -6*modifier, "UInt", 1*modifier)
		sleep 72
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		; 25
		DllCall("mouse_event", "UInt", 0x01, "UInt", -2*modifier, "UInt", 0*modifier)
		sleep 72
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
...
else if m416 {						;SPITFIRE RECOIL (by mgsweet - 21/06/2021)
	loop {
		sleep, 10
		DllCall("mouse_event", uint, 2, int, 0, int, 0, uint, 0, int, 0)
		sleep 1
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", 6*modifier, "UInt", 6*modifier)
		sleep 112
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -8*modifier, "UInt", 0*modifier)
		sleep 112
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", 0*modifier, "UInt", 0*modifier)
		sleep 112
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
	...
	loop {
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -3*modifier, "UInt", 0*modifier)
		sleep 100
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -8*modifier, "UInt", 2*modifier)
		sleep 100
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
	...
	loop {
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -2*modifier, "UInt", 20*modifier)
		sleep 100
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		}
		DllCall("mouse_event", "UInt", 0x01, "UInt", 4*modifier, "UInt", 20*modifier)
		sleep 100
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", 5*modifier, "UInt", 4*modifier)
		sleep 100
		if !GetKeyState(key_shoot) {
	...
	loop {
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", 12*modifier, "UInt", 10*modifier)
		sleep 100
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
	...
	loop {
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -9*modifier, "UInt", 11*modifier)
		sleep 63
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		}
		DllCall("mouse_event", "UInt", 0x01, "UInt", 0*modifier, "UInt", 11*modifier)
		sleep 63
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -5*modifier, "UInt", 15*modifier)
		sleep 63
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		}
		DllCall("mouse_event", "UInt", 0x01, "UInt", -7*modifier, "UInt", 10*modifier)
		sleep 63
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
		...
		DllCall("mouse_event", "UInt", 0x01, "UInt", -5*modifier, "UInt", -2*modifier)
		sleep 63
		if !GetKeyState(key_shoot) {
			DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
			break
